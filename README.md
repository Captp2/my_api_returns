!! Most commits were made on my school git server !!
...
Right now the API concerns two entities : User and Task, in a one-to-many relation.
...
If you want to add a task, make sure the user from the user_id exists.
